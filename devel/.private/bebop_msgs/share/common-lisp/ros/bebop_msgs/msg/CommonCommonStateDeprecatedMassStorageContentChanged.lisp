...
(cl:defclass <CommonCommonStateDeprecatedMassStorageContentChanged> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass CommonCommonStateDeprecatedMassStorageContentChanged (<CommonCommonStateDeprecatedMassStorageContentChanged>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <CommonCommonStateDeprecatedMassStorageContentChanged>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'CommonCommonStateDeprecatedMassStorageContentChanged)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bebop_msgs-msg:<CommonCommonStateDeprecatedMassStorageContentChanged> is deprecated: use bebop_msgs-msg:CommonCommonStateDeprecatedMassStorageContentChanged instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <CommonCommonStateDeprecatedMassStorageContentChanged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bebop_msgs-msg:header-val is deprecated.  Use bebop_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'mass_storage_id-val :lambda-list '(m))
(cl:defmethod mass_storage_id-val ((m <CommonCommonStateDeprecatedMassStorageContentChanged>))
...
(cl:defmethod nbPhotos-val ((m <CommonCommonStateDeprecatedMassStorageContentChanged>))
...
(cl:defmethod nbVideos-val ((m <CommonCommonStateDeprecatedMassStorageContentChanged>))
...
(cl:defmethod nbPuds-val ((m <CommonCommonStateDeprecatedMassStorageContentChanged>))
...
(cl:defmethod nbCrashLogs-val ((m <CommonCommonStateDeprecatedMassStorageContentChanged>))
  ...
  (nbCrashLogs m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <CommonCommonStateDeprecatedMassStorageContentChanged>) ostream)
  "Serializes a message object of type '<CommonCommonStateDeprecatedMassStorageContentChanged>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CommonCommonStateDeprecatedMassStorageContentChanged>) istream)
  "Deserializes a message object of type '<CommonCommonStateDeprecatedMassStorageContentChanged>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CommonCommonStateDeprecatedMassStorageContentChanged>)))
  "Returns string type for a message object of type '<CommonCommonStateDeprecatedMassStorageContentChanged>"
  "bebop_msgs/CommonCommonStateDeprecatedMassStorageContentChanged")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CommonCommonStateDeprecatedMassStorageContentChanged)))
  "Returns string type for a message object of type 'CommonCommonStateDeprecatedMassStorageContentChanged"
  "bebop_msgs/CommonCommonStateDeprecatedMassStorageContentChanged")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CommonCommonStateDeprecatedMassStorageContentChanged>)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CommonCommonStateDeprecatedMassStorageContentChanged)))
  "Returns md5sum for a message object of type 'CommonCommonStateDeprecatedMassStorageContentChanged"
  "54ba89d250643620665f04ab5991b8ef")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CommonCommonStateDeprecatedMassStorageContentChanged>)))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CommonCommonStateDeprecatedMassStorageContentChanged)))
  "Returns full string definition for message of type 'CommonCommonStateDeprecatedMassStorageContentChanged"
  (cl:format cl:nil "# CommonCommonStateDeprecatedMassStorageContentChanged~%# auto-generated from up stream XML files at~%#   github.com/Parrot-Developers/libARCommands/tree/master/Xml~%# To check upstream commit hash, refer to last_build_info file~%# Do not modify this file by hand. Check scripts/meta folder for generator files.~%#~%# SDK Comment: Mass storage content changed.~%~%Header header~%~%# Mass storage id (unique)~%uint8 mass_storage_id~%# Number of photos (does not include raw photos)~%uint16 nbPhotos~%# Number of videos~%uint16 nbVideos~%# Number of puds~%uint16 nbPuds~%# Number of crash logs~%uint16 nbCrashLogs~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <CommonCommonStateDeprecatedMassStorageContentChanged>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <CommonCommonStateDeprecatedMassStorageContentChanged>))
  "Converts a ROS message object to a list"
  (cl:list 'CommonCommonStateDeprecatedMassStorageContentChanged
