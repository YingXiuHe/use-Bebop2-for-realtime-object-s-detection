...
class CommonCommonStateDeprecatedMassStorageContentChanged {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('nbPuds')) {
        this.nbPuds = initObj.nbPuds
      }
      else {
        this.nbPuds = 0;
      }
      if (initObj.hasOwnProperty('nbCrashLogs')) {
        this.nbCrashLogs = initObj.nbCrashLogs
      }
      else {
        this.nbCrashLogs = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [nbPuds]
    bufferOffset = _serializer.uint16(obj.nbPuds, buffer, bufferOffset);
    // Serialize message field [nbCrashLogs]
    bufferOffset = _serializer.uint16(obj.nbCrashLogs, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommonCommonStateDeprecatedMassStorageContentChanged(null);
    ...
    // Deserialize message field [nbPuds]
    data.nbPuds = _deserializer.uint16(buffer, bufferOffset);
    // Deserialize message field [nbCrashLogs]
    data.nbCrashLogs = _deserializer.uint16(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommonCommonStateDeprecatedMassStorageContentChanged(null);
    ...
    if (msg.nbPuds !== undefined) {
      resolved.nbPuds = msg.nbPuds;
    }
    else {
      resolved.nbPuds = 0
    }

    if (msg.nbCrashLogs !== undefined) {
      resolved.nbCrashLogs = msg.nbCrashLogs;
    }
    else {
      resolved.nbCrashLogs = 0
    }
...
module.exports = CommonCommonStateDeprecatedMassStorageContentChanged;
