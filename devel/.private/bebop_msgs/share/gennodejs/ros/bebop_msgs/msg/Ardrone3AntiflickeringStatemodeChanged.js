...
class Ardrone3AntiflickeringStatemodeChanged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Ardrone3AntiflickeringStatemodeChanged(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Ardrone3AntiflickeringStatemodeChanged(null);
...
Ardrone3AntiflickeringStatemodeChanged.Constants = {
  MODE_AUTO: 0,
  MODE_FIXEDFIFTYHERTZ: 1,
  MODE_FIXEDSIXTYHERTZ: 2,
}

module.exports = Ardrone3AntiflickeringStatemodeChanged;
