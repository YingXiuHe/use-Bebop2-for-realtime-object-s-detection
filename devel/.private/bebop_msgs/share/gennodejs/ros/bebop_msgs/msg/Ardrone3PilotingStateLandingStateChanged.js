...
class Ardrone3PilotingStateLandingStateChanged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Ardrone3PilotingStateLandingStateChanged(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Ardrone3PilotingStateLandingStateChanged(null);
...
Ardrone3PilotingStateLandingStateChanged.Constants = {
  STATE_LINEAR: 0,
  STATE_SPIRAL: 1,
}

module.exports = Ardrone3PilotingStateLandingStateChanged;
