...
class CommonChargerStateLastChargeRateChanged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommonChargerStateLastChargeRateChanged(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommonChargerStateLastChargeRateChanged(null);
...
CommonChargerStateLastChargeRateChanged.Constants = {
  RATE_UNKNOWN: 0,
  RATE_SLOW: 1,
  RATE_MODERATE: 2,
  RATE_FAST: 3,
...
module.exports = CommonChargerStateLastChargeRateChanged;
