...
class CommonOverHeatStateOverHeatChanged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommonOverHeatStateOverHeatChanged(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommonOverHeatStateOverHeatChanged(null);
...
module.exports = CommonOverHeatStateOverHeatChanged;
