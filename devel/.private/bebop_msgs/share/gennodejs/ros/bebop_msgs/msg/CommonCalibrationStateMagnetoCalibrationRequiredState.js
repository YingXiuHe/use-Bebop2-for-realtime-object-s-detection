...
class CommonCalibrationStateMagnetoCalibrationRequiredState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('required')) {
        this.required = initObj.required
      }
      else {
        this.required = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [required]
    bufferOffset = _serializer.uint8(obj.required, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommonCalibrationStateMagnetoCalibrationRequiredState(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [required]
    data.required = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommonCalibrationStateMagnetoCalibrationRequiredState(null);
    ...
    if (msg.required !== undefined) {
      resolved.required = msg.required;
    }
    else {
      resolved.required = 0
    }
...
module.exports = CommonCalibrationStateMagnetoCalibrationRequiredState;
