...
class CommonCommonStateCurrentTimeChanged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommonCommonStateCurrentTimeChanged(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommonCommonStateCurrentTimeChanged(null);
...
module.exports = CommonCommonStateCurrentTimeChanged;
