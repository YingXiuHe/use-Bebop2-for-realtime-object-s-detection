...
class CommonARLibsVersionsStateControllerLibARCommandsVersion {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommonARLibsVersionsStateControllerLibARCommandsVersion(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommonARLibsVersionsStateControllerLibARCommandsVersion(null);
...
module.exports = CommonARLibsVersionsStateControllerLibARCommandsVersion;
