...
class CommonARLibsVersionsStateSkyControllerLibARCommandsVersion {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommonARLibsVersionsStateSkyControllerLibARCommandsVersion(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommonARLibsVersionsStateSkyControllerLibARCommandsVersion(null);
...
module.exports = CommonARLibsVersionsStateSkyControllerLibARCommandsVersion;
