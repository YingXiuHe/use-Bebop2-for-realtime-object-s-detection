...
class Ardrone3PilotingStateAlertStateChanged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Ardrone3PilotingStateAlertStateChanged(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Ardrone3PilotingStateAlertStateChanged(null);
...
Ardrone3PilotingStateAlertStateChanged.Constants = {
  STATE_NONE: 0,
  STATE_USER: 1,
  STATE_CUT_OUT: 2,
...
module.exports = Ardrone3PilotingStateAlertStateChanged;
