...
class Ardrone3PilotingStateFlatTrimChanged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Ardrone3PilotingStateFlatTrimChanged(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Ardrone3PilotingStateFlatTrimChanged(null);
...
module.exports = Ardrone3PilotingStateFlatTrimChanged;
