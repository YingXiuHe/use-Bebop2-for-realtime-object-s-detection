...
class CommonCalibrationStateMagnetoCalibrationStartedChanged {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.started, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommonCalibrationStateMagnetoCalibrationStartedChanged(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [started]
    data.started = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommonCalibrationStateMagnetoCalibrationStartedChanged(null);
...
module.exports = CommonCalibrationStateMagnetoCalibrationStartedChanged;
