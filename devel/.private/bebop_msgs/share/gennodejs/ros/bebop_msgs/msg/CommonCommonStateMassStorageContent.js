...
class CommonCommonStateMassStorageContent {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommonCommonStateMassStorageContent(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommonCommonStateMassStorageContent(null);
...
module.exports = CommonCommonStateMassStorageContent;
