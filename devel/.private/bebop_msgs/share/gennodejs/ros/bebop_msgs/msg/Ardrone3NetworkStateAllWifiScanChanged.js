...
class Ardrone3NetworkStateAllWifiScanChanged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Ardrone3NetworkStateAllWifiScanChanged(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Ardrone3NetworkStateAllWifiScanChanged(null);
...
module.exports = Ardrone3NetworkStateAllWifiScanChanged;
