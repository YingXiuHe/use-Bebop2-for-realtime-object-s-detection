...
class Ardrone3PilotingStateAutoTakeOffModeChanged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Ardrone3PilotingStateAutoTakeOffModeChanged(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Ardrone3PilotingStateAutoTakeOffModeChanged(null);
...
module.exports = Ardrone3PilotingStateAutoTakeOffModeChanged;
