...
class Ardrone3CameraStatedefaultCameraOrientationV2 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Ardrone3CameraStatedefaultCameraOrientationV2(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Ardrone3CameraStatedefaultCameraOrientationV2(null);
...
module.exports = Ardrone3CameraStatedefaultCameraOrientationV2;
