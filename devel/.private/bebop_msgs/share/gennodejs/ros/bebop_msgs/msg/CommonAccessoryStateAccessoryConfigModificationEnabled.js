...
class CommonAccessoryStateAccessoryConfigModificationEnabled {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommonAccessoryStateAccessoryConfigModificationEnabled(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommonAccessoryStateAccessoryConfigModificationEnabled(null);
...
module.exports = CommonAccessoryStateAccessoryConfigModificationEnabled;
